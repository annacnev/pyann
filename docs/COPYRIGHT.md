...
package, consisting of file NN.cc found in lib/, which are copyright as
described below.
...
This R package is copyright Samuel Kemp 2005-9 and and Gregory Jefferis
2009-2013, with the exception of files from v 1.1.3 of the ANN library,
consisting of all files in src/ except for NN.cc, Makevars and Makevars.win
which are copyright as described below.
